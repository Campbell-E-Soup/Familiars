...
#macro SCRIBBLE_DEFAULT_WAVE_SIZE           3        //Default wave amplitude, in pixels
...
#macro SCRIBBLE_DEFAULT_WAVE_SPEED          0.15      //Default wave speed. Larger numbers cause characters to move up and down more rapidly
